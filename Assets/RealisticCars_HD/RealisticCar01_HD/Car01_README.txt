...
Car has 4 openable doors. Just select "Car01_Door_BackLeft" or any other door under "Car01_Body" and rotate it in Y axis.
...
Main Body part includes 2 materials. One for Car paint (RealisticCar01_Body - You can adjust color, metallic and smothness freely. 
Also You can make Your own custom paint texture using Car01_Body_PSD file) and second for everything else 
(Car01_Parts - Color, metallic and smothness are defined by textures. You can find 2 different texture sets for the parts, one has Chromed details and another has black plastic)
